...
def main():
    ...
    gen = EmotionTrigramGenerator(from __future__ import annotations
...
# ---------------------------
# Example corpus (replace or load your own later)
# ---------------------------
SAMPLE_CORPUS: Dict[str, List[str]] = {
    "happy": [
        "The lantern warms the corridor.",
        "I am glad you found your way back.",
        "Your voice carries a gentle hope.",
...
def main():
    ...
    gen = EmotionTrigramGenerator(TEXTDICTIONARY)
    seed_tokens = [w for w in args.seed.strip().split() if w] if args.seed else None
